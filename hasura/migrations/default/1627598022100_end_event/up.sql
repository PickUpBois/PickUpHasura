...
DECLARE 
    ...
    team1_scores_json jsonb;
    team2_scores_json jsonb;
    team1_id INT;
    team2_id INT;
BEGIN
    team1_scores_json = json_build_object('scores', array_to_json(team1_scores::int[]));
    team2_scores_json = json_build_object('scores', array_to_json(team2_scores::int[]));
    INSERT INTO event_teams (event_id, set_scores) VALUES (p_event_id, team1_scores_json) RETURNING team_id INTO team1_id;
    INSERT INTO event_teams (event_id, set_scores) VALUES (event_id, team2_scores_json) RETURNING team_id INTO team2_id;
