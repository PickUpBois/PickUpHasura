...
RETURNS SETOF notifications as $$
    ...
    (
    SELECT NULL as event_id, u.user_id as actor_id, r1.created_at as created_at, 'friendRequestSend' as type
    FROM users as u
    ...
    (
    /*Event invitations*/
    SELECT DISTINCT e.event_id, a.invited_by as actor_id, a.invited_at as created_at, 'eventInvitation' as type /*enum value is eventInvitation*/
    FROM events as e
    ...
    SELECT DISTINCT e.event_id, NULL as actor_id, e.start_date as created_at, 'finishEvent' as type /*enum value is finishEvent*/
    FROM events as e
    LEFT JOIN event_attendees as a ON e.event_id = a.event_id
    ...
    SELECT DISTINCT e.event_id as event_id, NULL as actor_id, a.invited_at as created_at, 'voteForMvp' as type
    FROM events as e
    LEFT JOIN event_attendees as a ON e.event_id = a.event_id
