...
DECLARE 
    ...
    team2_id INT;
BEGIN
    INSERT INTO event_teams (event_id, set_scores) VALUES (p_event_id, format('%s', array_to_json(team1_scores::int[]))) RETURNING team_id INTO team1_id;
    INSERT INTO event_teams (event_id, set_scores) VALUES (event_id, format('%s', array_to_json(team2_scores::int[]))) RETURNING team_id INTO team2_id;
